...
object EclatDemo extends App {
  ...
  def firstStep() = {
    ...
    println("Trasformazione dataset in verticale:\n" + itemTransazioni.mkString("\n"))
    println("-----------------------------------")
  ...
  def avviaIntersezione(transazioniElementiSingoli: Set[(Set[String], Set[Int])], itemSingoli: Set[String]): Map[Set[String], Set[Int]] = {
    ...
    def intersezione(livelloCombinazione: Int, transazioniTrovate: Map[Set[String], Set[Int]]): Map[Set[String], Set[Int]] = {
      ...
      * "livelloCombinazione", dunque del passo che stiamo eseguendo. */
      ...
      if (possibiliCombinazioni.nonEmpty) {
        println("Candidati passo " + livelloCombinazione + ":\n" + possibiliCombinazioni.mkString("\n"))
        println("-----------------------------------")
        ...
        println("Candidati con subset di essi:\n" + tuplePossibiliMap.mkString("\n"))
        println("-----------------------------------")
        ...
        println("Candidati dopo la 'prune':\n" + tuplePossibiliCandidate.mkString("\n"))
        println("-----------------------------------")
