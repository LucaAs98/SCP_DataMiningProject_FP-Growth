...
object NonordfpPar extends App {
  ...
  Utils.scriviSuFileFrequentItemSet(result, numTransazioni, "NonOrderFpParResult.txt")
  Utils.scriviSuFileSupporto(result, numTransazioni, "NonOrderFpParSupport.txt")
}