...
object FPGrowthClassicPar extends App {
 ...
 /* val numTransazioni = dataset.size.toFloat
  ...
  Utils.scriviSuFileFrequentItemSet(result, numTransazioni, "FPGrowthClassicParResult.txt")
  Utils.scriviSuFileSupporto(result, numTransazioni, "FPGrowthResultClassicParSupport.txt")*/
}
